		...
		<h1>
			...
			<div class="post">
				<div class="details">
					...
					<p class="info">posted 3 hours ago in <?php echo date("Y"); ?></p>

				</div>
				<div class="body">
					<p><?php echo $largeText; ?></p>
				</div>
				<div class="x"></div>
			</div>
